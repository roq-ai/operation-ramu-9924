...
import { getJobListingById } from 'apiSdk/job-listings';
  ...
  const { data, error, isLoading, mutate } = useSWR<JobListingInterface>(
    ...
    () =>
      getJobListingById(id, {
        relations: ['employer', 'application'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('job_listing', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/job-listings/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/applications/create?job_listing_id=${data?.id}`}>
