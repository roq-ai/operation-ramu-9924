...
import { getJobListings } from 'apiSdk/job-listings';
...
function ApplicationCreatePage() {
  ...
  const formik = useFormik<ApplicationInterface>({
    initialValues: {
      status: '',
      job_listing_id: (router.query.job_listing_id as string) ?? null,
